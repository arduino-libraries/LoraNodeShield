 ...
 */
#define LORAWAN_APPLICATION_EUI                     { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x00, 0x19, 0x83 }
...
static void PrepareTxFrame( uint8_t port )
{
    ...
    case 2:
        ...
        //    altitudeGps = GpsGetLatestGpsAltitude( );                           // in m
            ...
            AppData[0] = 0x53;//AppLedStateOn;
            AppData[1] = 0xFF;//( pressure >> 8 ) & 0xFF;
            AppData[2] = 0xAA;//pressure & 0xFF;
            AppData[3] = 0x99;//( temperature >> 8 ) & 0xFF;
            AppData[4] = 0xDD;//temperature & 0xFF;
            AppData[5] = 0x88;//( altitudeBar >> 8 ) & 0xFF;
            AppData[6] = 0x77;//altitudeBar & 0xFF;
            AppData[7] = 0xCC;//batteryLevel;
            AppData[8] = 0x66;//( latitude >> 16 ) & 0xFF;
            AppData[9] = 0x55;//( latitude >> 8 ) & 0xFF;
            AppData[10] = 0xBB;//latitude & 0xFF;
            AppData[11] = 0x44;//( longitude >> 16 ) & 0xFF;
            AppData[12] = 0x33;//( longitude >> 8 ) & 0xFF;
            AppData[13] = 0xAA;//longitude & 0xFF;
            AppData[14] = 0x22;//( altitudeGps >> 8 ) & 0xFF;
            AppData[15] = 0x11;//altitudeGps & 0xFF;
#elif defined( USE_BAND_915 ) || defined( USE_BAND_915_HYBRID )
            int16_t temperature = 0;
            int32_t latitude, longitude = 0;
           ...
           // GpsGetLatestGpsPositionBinary( &latitude, &longitude );
            ...
            AppData[0] = 0x88;//AppLedStateOn;
            AppData[1] = 0x77;//temperature;                                           // Signed degrees Celcius in half degree units. So,  +/-63 C
            AppData[2] = 0xCC;//batteryLevel;                                          // Per LoRaWAN spec; 0=Charging; 1...254 = level, 255 = N/A
            AppData[3] = 0x66;//( latitude >> 16 ) & 0xFF;
            AppData[4] = 0x55;//( latitude >> 8 ) & 0xFF;
            AppData[5] = 0xBB;//latitude & 0xFF;
            AppData[6] = 0x44;//( longitude >> 16 ) & 0xFF;
            AppData[7] = 0x33;//( longitude >> 8 ) & 0xFF;
            AppData[8] = 0xAA;//longitude & 0xFF;
            AppData[9] = 0x22;//( altitudeGps >> 8 ) & 0xFF;
            AppData[10] = 0x11;//altitudeGps & 0xFF;
#endif
        }
        break;
    case 224:
